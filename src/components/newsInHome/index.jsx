        ...
        return(
            ...
            <div className="wrap-news-in-home">
                ...
                <div className="sub-news" >
                    <h2>Nơi ở Airbnb Plus</h2>
                    <div className="content" style={{backgroundImage: "url('https://a0.muscache.com/4ea/air/v2/pictures/ea6285d9-5352-4447-b13d-b39bfc92dfe5.jpg?t=c:w1131-h343,r:w1131-h343-sfit,e:fjpg-c75')"}}>
                        <div className="inner">
                        <div className="logo"><span>{this.state.logoPlus}</span></div>
